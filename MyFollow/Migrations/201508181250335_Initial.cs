namespace MyFollow.Migrations
{
    ...
    public partial class Initial : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        Facebook = c.String(),
                        Password = c.String(),
                        ApprovalFlag = c.Boolean(nullable: false),
                    })
                .PrimaryKey(t => t.Id);
                ...
                c => new
                    {
                        ...
                        Introduction = c.String(maxLength: 140),
                        Details = c.String(maxLength: 1000),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.ProductOwners", t => t.Poid, cascadeDelete: true)
                .Index(t => t.Poid);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Products", "Poid", "dbo.ProductOwners");
            ...
            DropIndex("dbo.Products", new[] { "Poid" });
